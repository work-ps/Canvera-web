...
const ORIENTATION_SIZES = {
  Landscape: [
    ...
    { id: 'l-6x8',   dims: '6×8"',   cmDims: '15×20 cm', w:  8,   h:  6, tier: 'Small',  popular: false },
  ...
  Square: [
    { id: 'q-8x8',   dims: '8×8"',   cmDims: '20×20 cm', w:  8, h:  8, tier: 'Small',  popular: false },
...
const SizeIcons = {
  ...
  'l-6x8':   <svg viewBox="0 0 64 64" fill="none"><rect x="6"    y="12.5" width="52" height="39" rx="3" stroke="currentColor" strokeWidth="2"/></svg>,
  ...
  'p-6x8':   <svg viewBox="0 0 64 64" fill="none"><rect x="12.5" y="6" width="39" height="52" rx="3" stroke="currentColor" strokeWidth="2"/></svg>,
  ...
  'q-8x8':   <svg viewBox="0 0 64 64" fill="none"><rect x="7" y="7" width="50" height="50" rx="3" stroke="currentColor" strokeWidth="2"/></svg>,
