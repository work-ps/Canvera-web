...
const deals = [
  {
    tag: 'Limited Time',
    title: 'Monsoon Album Sale',
    desc: 'Flat 30% off on all premium flushmount albums. Use code MONSOON30 at checkout.',
    highlight: '30% OFF',
    accent: 'amber',
  ...
  },
  {
    ...
    desc: 'Sign up today and get an exclusive 15% discount on your very first album order.',
    highlight: '15% OFF',
    accent: 'leaf',
  ...
  },
  {
    ...
    desc: 'Order any 3 albums and receive the 4th album absolutely free. Perfect for wedding season.',
    highlight: '3+1 FREE',
    accent: 'petrol',
  ...
  {
    tag: 'Free Upgrade',
    title: 'Premium Cover Upgrade',
    desc: 'Get a free leather cover upgrade worth ₹1,500 on all orders above ₹5,000 this month.',
    highlight: 'FREE',
    accent: 'amber',
