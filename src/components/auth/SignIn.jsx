  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <h1>Welcome Back</h1>
        <p className="auth-subtitle">Sign in to your photographer account</p>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="auth-options">
            <label>
              <input type="checkbox" style={{ accentColor: 'var(--petrol-600)' }} />
              {' '}Remember me
            </label>
        ...
        <div className="auth-footer">
          New to Canvera? <Link to="/register">Create a free account</Link>
        </div>
      </div>
    </div>
  )
